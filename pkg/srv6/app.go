...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go srv6 ../../ebpf/srv6/srv6.c -- -I../../ebpf/common -O2 -Wall -Wno-compare-distinct-pointer-types -Wno-unused-variable
